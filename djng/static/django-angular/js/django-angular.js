...
<<<<<<< HEAD:djng/static/djng/js/django-angular.js
// django-angular - v0.7.16 - 2016-02-29
=======
// django-angular - v0.7.16 - 2016-02-28
>>>>>>> 3e1d272386078b62b7c16cb0c2e80d9226cce225:djng/static/django-angular/js/django-angular.js
...
(function (angular, undefined) {
  ...
  angular.module('ng.django.angular.messages', ['ng.django.forms']).directive('form', formDirectiveFactory()).directive('ngForm', formDirectiveFactory(true)).directive('djngError', djngError).directive('djngRejected', djngRejected).factory('djngAngularMessagesForm', djngAngularMessagesForm);
  /**
  ...
  function djngError($timeout) {
    return {
      ...
      link: function (scope, element, attrs, ctrls) {
        var formCtrl = ctrls[0], ngModel = ctrls[1];
...
(function (angular, undefined) {
  ...
  djng_forms_module.directive('ngModel', [
    '$log',
    function ($log) {
