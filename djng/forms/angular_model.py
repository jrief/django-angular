...
class NgModelFormMixin(NgFormBaseMixin):
    ...
    def get_field_errors(self, field):
        ...
        errors.append(SafeTuple((identifier, self.field_error_css_classes, '$dirty', '$message', 'invalid', '$message')))
        return errors

    def non_field_errors(self):
        errors = super(NgModelFormMixin, self).non_field_errors()
        errors.append(SafeTuple((self.form_name, self.form_error_css_classes, '$dirty', '$message', 'invalid', '$message')))
        return errors
