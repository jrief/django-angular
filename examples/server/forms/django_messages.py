...
class MessagesForm(NgModelFormMixin, NgFormValidationMixin, Bootstrap3Form):
    ...
    LEVELS = ((django.contrib.messages.INFO, 'Info'),
    ...
    count = forms.DecimalField(min_value=1, max_value=5,
       help_text='The number of times the message will be added to django messages, to demonstrate the return of multiple messages. Max 5.')
