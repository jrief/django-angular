...
latex_documents = [
  ('index', 'django-angular.tex', 'django-angular Documentation',
   'Jacob Rief', 'manual'),
]
...
man_pages = [
    ('index', 'django-angular', 'django-angular Documentation',
     ['Jacob Rief'], 1)
]
...
texinfo_documents = [
  ('index', 'django-angular', 'django-angular Documentation',
   'Jacob Rief', 'django-angular', 'One line description of project.',
   'Miscellaneous'),
]
